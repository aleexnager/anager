...
const EmailSection = () => {
  ...
  return (
    <section
      id="contact"
      className="grid md:grid-cols-2 my-12 md:my-24 xl:my-48 py-24 gap-4 relative"
    >
      ...
      <div className="mb-4">
        ...
        <div className="socials flex flex-row gap-4 md:gap-5">
          <Link href="https://github.com/aleexnager">
            <svg
              className="w-[48px] h-[48px] bg-[#121212] text-white rounded-md hover:text-primary-500 transition-all duration-300 ease-in-out"
              aria-hidden="true"
          ...
          <Link href="https://www.linkedin.com/in/anager/">
            <svg
              className="w-[48px] h-[48px] bg-white text-[#121212] rounded-md hover:bg-primary-500 transition-all duration-300 ease-in-out"
              aria-hidden="true"
              xmlns="http://www.w3.org/2000/svg"
              fill="currentColor"
              viewBox="0 0 24 24"
